...
10. [PR 评审与合并规范 - GitHub 为例](docs/10-PR评审与合并规范-GitHub为例.md)
   理解 Pull Request 的角色、GitHub 上的 review 动作，以及三种常见合并方式的差异。
11. [轻量发布流与版本发布](docs/11-轻量发布流与版本发布.md)
   把 `tag` 放进版本号、release note、回滚点和热修复的完整发布语境。

## 推荐路径

- 如果你是第一次系统学习 Git，按 1 -> 11 顺序读即可。
...
- 如果你已经掌握第 9 篇的高频能力，接下来优先看第 10、11 篇，把 PR 评审和版本发布这两类团队落地流程补齐。
