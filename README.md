...
7. [Git worktree 与并行开发](docs/7-Git-worktree与并行开发.md)
   处理主线、实验线、修复线以及“一人协调多个 AI 并行开发”的多上下文场景。
8. [Git 高频进阶能力](docs/8-Git高频进阶能力.md)
   补齐 `stash`、`cherry-pick`、`tag`、`restore` / `reset` / `revert` 等常用能力。

## 推荐路径

- 如果你是第一次系统学习 Git，按 1 -> 8 顺序读即可。
- 如果你已经做完第 4 篇本地练习，下一步优先看第 5、6 篇，再进入第 7 篇的 `worktree`。
- 如果你已经在用 AI 协助开发，第 7 篇会直接帮助你把并行开发上下文管理清楚。
